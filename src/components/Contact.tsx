...
export default function Contact() {
  return (
    ...
    >
      <div className="grid items-center gap-6 rounded-3xl border border-line bg-bg-glass-strong p-[clamp(28px,4vw,48px)] shadow-(--shadow-glass-lg) backdrop-blur-[28px] backdrop-saturate-200 sm:grid-cols-[2fr_auto]">
        <div>
          <span className="eyebrow-line mb-3">04 / Связь</span>
          <h2 className="font-display text-[clamp(24px,3vw,36px)] font-bold leading-[1.15] tracking-tight">
      ...
      <div className="mt-5 flex flex-wrap items-center gap-3">
        {SOCIALS.map((s) => (
          ...
          >
            <span className="grid size-5.5 place-items-center rounded-full border border-line bg-bg-glass-strong text-[10px] font-semibold">
              {s.glyph}
            </span>
            {s.name}
          </a>
